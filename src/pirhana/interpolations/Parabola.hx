...
class Parabola implements Interpolation.Interpolable{
     ...
     */
    public static function fromPoints(p1:Point, p2:Point, height:Int){
    ...
    public function getRatio(ratio:Float):Point{
